...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2"><table width="101%" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr bgcolor="#99FF00">
        <td width="604" bgcolor="#99FF00" onmouseover="showmenu('scripting')" onmouseout="hidemenu('scripting')"><a></a><a href="confirm.php"><img src="images/Untitled-1.png" width="15" height="15" border="0" /></a>&nbsp;&nbsp;
            <?php
...
$result = mysql_query("SELECT * FROM messages WHERE receiver='".$_SESSION['SESS_FIRST_NAME'] ."' and status='pending' ORDER BY receiver ASC");
	...
	?>
            <br /></td>
        <td width="49" bgcolor="#99FF00" onmouseover="showmenu('tutorials')" onmouseout="hidemenu('tutorials')"><a href="member-profile.php">Home</a><br />
        </td>
        <td width="49" bgcolor="#99FF00" onmouseover="showmenu('scripting')" onmouseout="hidemenu('scripting')"><a href="member-index.php">Profile</a><br />
        </td>
        <td width="74" bgcolor="#99FF00" onmouseover="showmenu('validation')" onmouseout="hidemenu('validation')"><a>Account</a><br />
